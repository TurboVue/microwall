<template>
  ...
  >
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div
        class="hidden justify-between items-center w-full  !absolute  bg-white shadow-sm !translate-x-0 !translate-y-60px"
        md="flex w-auto order-1 !relative !transform-none shadow-none"
        id="dropdownMenu2"
      >
        <ul
          ...
          <li class="pa-2">
            <router-link :to="{ name: '/user/' }">
              <div
                ...
                class="text-gray-700 dark:text-gray-400 md:(hover:text-blue-700 dark:hover:text-white)"
                :class="{
                  '!text-blue-700 !dark:text-white': route.name === '/user/',
                }"
              >
                Users {{ notifications }}
              </div>
          ...
          <li class="pa-2">
            <router-link :to="{ name: '/post/add' }">
              <div
                class="text-gray-700 dark:text-gray-400 md:(hover:text-blue-700 dark:hover:text-white)"
                :class="{
                  '!text-blue-700 !dark:text-white': route.name === '/post/add',
                }"
              >
                Add post
              </div>
...
onMounted(()=> {
  new Dropdown(document.getElementById('dropdownMenu'), document.getElementById('dropdownButton'), {
    placement: 'bottom',
    onHide: () => {
  ...
  new Dropdown(document.getElementById('dropdownMenu2'), document.getElementById('dropdownButton2'), {
    placement: 'bottom',
    onHide: () => {
      console.log('dropdown has been hidden');
    },
